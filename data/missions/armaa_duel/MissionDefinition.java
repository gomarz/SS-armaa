...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
        ...
        public void init(CombatEngineAPI engine) {
            ...
            FF.add("armaa_valkenmp", 0.25f);
            FF.add("armaa_valkenmp", 0.25f);
            FF.add("armaa_valkenmp", 0.25f);
            FF.add("armaa_valkenmp", 0.1f);
			
			DD.add("armaa_valkenmp", 0.15f);
            DD.add("armaa_valkenmp", 0.25f);
			
			FF2.add("armaa_valkenmp", .10f);
            FF2.add("armaa_valkenmp", 0.25f);
            FF2.add("armaa_valkenmp", 0.05f);
            FF2.add("armaa_valkenmp", 0.25f);
			FF2.add("armaa_valkenmp",.1f);

            DD2.add("armaa_valkenmp", 0.5f);
			
			CA.add("talon_wing", 0.25f);
            CA.add("broadsword_wing", 0.25f);
			
			BB.add("claw_wing", 0.2f);
            BB.add("claw_wing", 0.5f);
