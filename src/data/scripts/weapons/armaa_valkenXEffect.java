...
public class armaa_valkenXEffect implements EveryFrameWeaponEffectPlugin {
    ...
    private float overlap = 0, originalRArmPos = 0f, originalArmPos = 0f, originalShoulderPos = 0f;
    private final float TORSO_OFFSET = -45, RIGHT_ARM_OFFSET = -25, MAX_OVERLAP = 10, LPAULDRONOFFSET = -5;
