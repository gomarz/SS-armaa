...
public class armaa_shotgunEveryFrameEffect2 implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin, OnHitEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine)  
	{
		...
		{
				engine.addSmoothParticle(projectile.getLocation(), new Vector2f(0,0), 100, 2, 0.10f, Color.white);
				engine.addHitParticle(projectile.getLocation(), new Vector2f(0,0), 100, 1, 0.4f, MUZZLE_FLASH_COLOR_GLOW);
