...
public class armaa_higEffect implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin, OnHitEffectPlugin {
	...
	{
        engine.spawnExplosion(point, new Vector2f(), PARTICLE_COLOR, 450f, 1f);
        engine.spawnExplosion(point, new Vector2f(), CORE_COLOR, 200f, 1f);
