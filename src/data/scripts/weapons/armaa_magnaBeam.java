...
public class armaa_magnaBeam implements BeamEffectPlugin {
    ...
    private final float CHARGEUP_PARTICLE_ANGLE_SPREAD = 120f;
    private final float A_2 = CHARGEUP_PARTICLE_ANGLE_SPREAD / 2;
    private final float CHARGEUP_PARTICLE_BRIGHTNESS = 1f;
    private final float CHARGEUP_PARTICLE_DISTANCE_MAX = 200f;
    private final float CHARGEUP_PARTICLE_DISTANCE_MIN = 150f;
    private final float CHARGEUP_PARTICLE_DURATION = 0.5f;
    private final float CHARGEUP_PARTICLE_SIZE_MAX = 5f;
    private final float CHARGEUP_PARTICLE_SIZE_MIN = 1f;
