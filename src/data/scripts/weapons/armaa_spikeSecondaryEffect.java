...
public class armaa_spikeSecondaryEffect implements OnHitEffectPlugin {
    ...
    private static final Color COLOR1 = new Color(0, 255, 200, 255);
    private static final Color COLOR2 = new Color(0, 245, 188, 255);
        ...
        if (target instanceof ShipAPI) {
            ...
            for (int x = 0; x < 3; x++) {
                ...
                engine.spawnEmpArcPierceShields(projectile.getSource(), point, empTarget, empTarget,
                        DamageType.ENERGY, dam, emp, 200f, null, 10f, COLOR1, COLOR2);
