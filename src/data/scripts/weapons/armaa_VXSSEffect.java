 ...
 */
public class armaa_VXSSEffect implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) 
	{
		...
		boolean meleeAnim = false;
		if(armL.getSpec().getWeaponId().contains("blade") || armL.getSpec().getWeaponId().contains("harpoon"))
			meleeAnim  = true;
		if(armL != null && meleeAnim)
		{
			WeaponAPI bladeArm = armL;
			float pos = originalArmPos;
		...
		if (weapon != null)
		{
			if(armL != null)
			{
				...
				if(bladeArm.getSpec().getWeaponId().contains("blade"))
				{
