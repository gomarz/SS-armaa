...
public class armaa_fluxBeamAEffect implements EveryFrameWeaponEffectPlugin{ 
    ...
    public float TURRET_OFFSET = 65f;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) 
	{
		if(engine.isPaused() || weapon.getShip().getOriginalOwner()==-1)
			...
			Vector2f offset = new Vector2f(TURRET_OFFSET, 12f);
