...
public class armaa_alesteEffect implements EveryFrameWeaponEffectPlugin {
    ...
    private IntervalUtil armorSyncInterval = new IntervalUtil(0.25f,0.5f);
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (gun == null || armL == null) {
            return;
        }
        if (engine.isPaused()) {
            return;
        }
        armorSyncInterval.advance(amount);
        if(armorSyncInterval.intervalElapsed())
