...
public class armaa_ashuraHammerGuidance extends BaseEveryFrameCombatPlugin {
     ...
     */
    public armaa_ashuraHammerGuidance(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        if (MathUtils.getDistance(proj.getLocation(), target.getLocation()) < proj.getCollisionRadius()) {
