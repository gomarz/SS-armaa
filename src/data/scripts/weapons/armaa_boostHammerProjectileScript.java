...
public class armaa_boostHammerProjectileScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public armaa_boostHammerProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
