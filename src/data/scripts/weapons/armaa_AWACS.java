...
public class armaa_AWACS implements EveryFrameWeaponEffectPlugin {
    ...
    public static float getEffectLevel(ShipAPI ship) 
    {
        float activeDrones = ship.getDeployedDrones() != null ? ship.getDeployedDrones().size() / (float) MAX_DRONES : 0;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        effectLevel = getEffectLevel(ship);
