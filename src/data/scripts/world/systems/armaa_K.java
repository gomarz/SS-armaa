...
public class armaa_K {
    ...
    public void generate(SectorAPI sector) {
        ...
        PlanetAPI meshanii = system.addPlanet("armaa_meshanii", pg_Star, "New Meshan", "arid", 215, 180f, 3500f, 365f);
        ...
        relay.setCircularOrbitPointingDown(system.getEntityById("nekki_Star"), 270, 6500, 300);
