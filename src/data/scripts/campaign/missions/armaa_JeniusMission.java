...
public class armaa_JeniusMission extends HubMissionWithSearch {
    ...
    protected boolean create(MarketAPI createdAt, boolean barEvent) {
        ...
        // I dont think this works the way I think it does
        beginStageTrigger(Stage.GO_TO_JENIUS);
    ...
    private void createMissionCharacters() {
        ...
        if (haveAnime) {
            redeye.setPortraitSprite("graphics/armaa/portraits/armaa_redeye_anim.png");
        } else {
        ...
        if (haveAnime) {
            imelda.setPortraitSprite("graphics/armaa/portraits/armaa_imelda_anim.png");
        } else {
    ...
    public void addDescriptionForNonEndStage(TooltipMakerAPI info, float width, float height) {
        ...
        if (currentStage == Stage.CONTACT) {
            info.addPara("Speak to Kade at Gamlin's bar" + ".", opad);
        }
    ...
    public boolean addNextStepText(TooltipMakerAPI info, Color tc, float pad) {
        ...
        if (currentStage == Stage.CONTACT) {
            info.addPara("Speak to Kade at the bar on New Meshan", tc, pad);
        }
        return false;
    }
