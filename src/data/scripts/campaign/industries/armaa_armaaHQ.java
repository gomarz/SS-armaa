...
public class armaa_armaaHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
    ...
    public CampaignFleetAPI spawnFleet(RouteData route) {
        ...
        String facID = Math.random() < 0.50f ? "armaarmatura_atac" : "armaarmatura_market";
        ...
        fleet.setFaction(market.getFactionId(), false);
...
//		fleet.addScript(ai);
    ...
    public String getRouteSourceId() {
        return getMarket().getId() + "_" + "armaarmatura";
    }
