...
public class armaa_drone_strike extends BaseShipSystemScript implements DroneStrikeStatsAIInfoProvider {
	...
	public static class DroneMissileScript extends BaseCombatLayeredRenderingPlugin {
		...
		public void advance(float amount) {
			...
			drone.setJitter(this, new Color(255,100,0, (int)(25 + 50 * jitterFraction)), 1f, 10, 1f, jitterMax);
...
//				drone.setHitpoints(-1f);
				...
				EmpArcEntityAPI arc = engine.spawnEmpArcVisual(ship.getLocation(), ship,
						missile.getLocation(), missile, thickness, new Color(255,130,100,255), Color.white);
