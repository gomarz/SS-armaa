package data.missions.armaa_duel;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.ENEMY, "drover_Starting", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
		api.addToFleet(FleetSide.ENEMY, "brawler_tritachyon_Standard", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
		api.addToFleet(FleetSide.ENEMY, "brawler_tritachyon_Standard", FleetMemberType.SHIP, false).getCaptain().setPersonality("aggressive");
        ...
        public void init(CombatEngineAPI engine) {
            runOnce = false;
            wave = 0;
			TOP.set(engine.getMapWidth()/2f,engine.getMapHeight());
            ...
            FF.add("condor_Strike", 0.25f);
            FF.add("condor_Strike", 0.25f);
            FF.add("condor_Support", 0.25f);
            FF.add("condor_Attack", 0.1f);
			
	    DD.add("brawler_tritachyon_Standard", 0.15f);
            DD.add("shrike_Attack", 0.25f);
			
	    FF2.add("armaa_hazard_standard", .25f);
            FF2.add("armaa_leynos_standard", 0.25f);
	    FF2.add("armaa_garegga_standard",.1f);

            DD2.add("medusa_PD", 0.5f);
			
			CA.add("brawler_tritachyon_Standard", 0.25f);
            CA.add("brawler_tritachyon_Standard", 0.25f);
			
			BB.add("brawler_tritachyon_Standard", 0.2f);
            BB.add("heron_Attack", 0.5f);

			CIV.add("armaa_hazard_standard",0.5f);
			CIV.add("armaa_garegga_standard",0.2f);
