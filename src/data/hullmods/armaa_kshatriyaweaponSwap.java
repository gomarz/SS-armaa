...
public class armaa_kshatriyaweaponSwap extends BaseHullMod{
            
    public Map<Integer,String> RIGHT_SELECTOR = new HashMap<>();
    {
        RIGHT_SELECTOR.put(0, "armaa_kshatriya_rightArm_spear");
        RIGHT_SELECTOR.put(1, "armaa_kshatriya_rightArm_melee");
    ...
    private final Map<String, Integer> SWITCH_TO_RIGHT = new HashMap<>();
    {
        ...
        SWITCH_TO_RIGHT.put("armaa_kshatriya_rightArm_spear",1);
        SWITCH_TO_RIGHT.put("armaa_kshatriya_rightArm_melee",0);
