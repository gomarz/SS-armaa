...
public class armaa_variableUnit extends BaseHullMod {
    ...
    static 
	{
        GROUND_BONUS.put("armaa_guardual", 25f);
    }	
	...
	public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) 
	{
		...
		String DNIText1 = "\u2022 Default speed, damage, and RoF. Disables hybrid slot.";
		String DNIText2 = "\u2022 Manuverability reduced by %s";
		String DNIText3 = "\u2022 Disabled shields (automatically transforms on activation)";
		String DNIText4 = "\u2022 +%s time dilation when near enemies or enemy projectiles";		
		
		String PDTitle = "Mode BETA";
		String PDText1 = "\u2022 +%s ballistic & energy damage / %s RoF. Disables missile slots.";
        ...
        transformInfo.addPara(DNIText1, pad, arr2, "Default","Disables hybrid slot");
        transformInfo.addPara(DNIText2, pad, Misc.getNegativeHighlightColor(), SPEED_MALUS+"%");
        transformInfo.addPara(DNIText3, pad, Misc.getHighlightColor(),"transforms");
        ...
        if (hullSize == ShipAPI.HullSize.FRIGATE) 
		{
			...
			pd.addPara(PDText1, pad, arr,(int)DAMAGE_BONUS + "%",-(int)DAMAGE_BONUS+10 + "%","Disables missile slots");
