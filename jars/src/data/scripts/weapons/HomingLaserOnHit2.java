...
public class HomingLaserOnHit2 implements OnHitEffectPlugin
{
    ...
    // It can be changed
    private static final Color EXPLOSION_COLOR = new Color(64,182,255,255);

    // -- stuff for tweaking particle characteristics ------------------------
    // color of spawned particles
    private static final Color PARTICLE_COLOR = new Color(250,197,92,255);
    ...
    private static final float PARTICLE_DURATION = 1.1f;
    ...
    {
		//EXPLOSION_COLOR = new Color(64,182,255,255);
		//PARTICLE_COLOR = new Color(250,197,92,255);
