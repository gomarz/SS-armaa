...
public class armaa_counterShieldScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TARGET_REACQUIRE_RANGE = 4000f;
	...
	private static final float GUIDANCE_DELAY_MAX = .08f;
	private static final float GUIDANCE_DELAY_MIN = .05f;
	...
	public void advance(float amount, List<InputEventAPI> events) {
		...
		if(Math.random() < .05f && !Global.getCombatEngine().isPaused())
		{
		   Global.getCombatEngine().addHitParticle(
			...
			new Color(50/255f,175f/255f,255f/255f,1f));
			
			Global.getCombatEngine().addSwirlyNebulaParticle(proj.getLocation(), new Vector2f(0.0f, 0.0f),MathUtils.getRandomNumberInRange((float)10.0f, (float)(60.0f)), 1.2f, 0.15f, 0.0f, 0.5f, new Color(50/255f,175f/255f,255f/255f,1f),false);	
		}
