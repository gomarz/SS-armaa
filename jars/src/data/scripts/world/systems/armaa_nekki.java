...
//		system.addRingBand(nekki_star, "misc", "rings_asteroids0", 256f, 3, Color.white, 256f, 13750, 345f, Terrain.ASTEROID_BELT, null);
       ...
       MarketAPI exsedolMarket = addMarketplace("armaarmatura_pirates", exsedol_station, null
		...
		FleetParamsV3 fparams = new FleetParamsV3(
					...
					CampaignUtils.addShipToFleet("armaa_hazard_standard",FleetMemberType.SHIP,fleet);				
					CampaignUtils.addShipToFleet("hyperion_Attack",FleetMemberType.SHIP,fleet);
 ...
 //Mini-function for generating derelicts
    private static SectorEntityToken addDerelict(StarSystemAPI system, String variantId, OrbitAPI orbit,
        ...
        SectorEntityToken ship = BaseThemeGenerator.addSalvageEntity(system, Entities.WRECK, "armaarmatura", params);
        ...
        if (defenders == null) {
            Misc.setDefenderOverride(ship, new DefenderDataOverride(Factions.REMNANTS,1f,300,425));
        }
        return ship;
    }
}
